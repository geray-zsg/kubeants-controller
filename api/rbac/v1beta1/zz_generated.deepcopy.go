...
func (in *DefaultOrCustomRoles) DeepCopyInto(out *DefaultOrCustomRoles) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DefaultOrCustomRoles.
func (in *DefaultOrCustomRoles) DeepCopy() *DefaultOrCustomRoles {
	if in == nil {
		return nil
	}
	out := new(DefaultOrCustomRoles)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RoleTemplateSpec) DeepCopyInto(out *RoleTemplateSpec) {
	*out = *in
	in.DefaultRoles.DeepCopyInto(&out.DefaultRoles)
	in.CustomRoles.DeepCopyInto(&out.CustomRoles)
}
...
func (in *RoleTemplateStatus) DeepCopyInto(out *RoleTemplateStatus) {
	*out = *in
	if in.AppliedDefaultRolesNamespace != nil {
		in, out := &in.AppliedDefaultRolesNamespace, &out.AppliedDefaultRolesNamespace
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AppliedCustomRolesNamespace != nil {
		in, out := &in.AppliedCustomRolesNamespace, &out.AppliedCustomRolesNamespace
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateRole) DeepCopyInto(out *TemplateRole) {
	*out = *in
	if in.Rules != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateRole.
func (in *TemplateRole) DeepCopy() *TemplateRole {
	if in == nil {
		return nil
	}
	out := new(TemplateRole)
	in.DeepCopyInto(out)
	return out
}
